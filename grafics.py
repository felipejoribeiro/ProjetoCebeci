...
# plt.title("Ajuste de V para 100 células no espaço")
...
# plt.title("Ajuste de V para 400 células no espaço")
...
# plt.title("Ajuste de V para 1000 células no espaço")
# plt.show()
...
ajuste = np.loadtxt("results/ResultadosGeraisAjustados.txt", dtype='float')
